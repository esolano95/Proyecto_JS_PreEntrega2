...
function seleccionProducto(tipoCarne) {
    ...
    if (tipoCarne === 1) {
        ...
        const buscarRes = arrayDeRes.filter((el) => el.id == producto)
        ...
        const buscarPollo = arrayDePollo.filter((el) => el.id == producto)
